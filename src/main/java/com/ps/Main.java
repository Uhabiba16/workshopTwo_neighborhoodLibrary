...
public class Main {
    public static void main(String[] args) {
        ...
        bookList[6] = new Book(7, "123-00007", "Harry Potter7", true, "");
        bookList[7] = new Book(8, "123-00008", "Game of Thrones1", false, "");
        bookList[8] = new Book(9, "123-00009", "Game of Thrones2", true, "");
        ...
        bookList[15] = new Book(16, "123-000016", "Java for Dummies", true, "");
